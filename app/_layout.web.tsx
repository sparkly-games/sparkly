      ...
      {Platform.OS === 'web' && !isShutdown && !maintenance && (
        <View style={styles.floatingContainer}>
          ...
          <View style={styles.trigger}>
            ...
            <ControlIcon name="game-controller-outline" onPress={() => Linking.openURL('https://github.com/sparkly-games/sparkly/issues/new?template=game-request.md')} style={{ marginLeft: 8 }} />
          </View>
