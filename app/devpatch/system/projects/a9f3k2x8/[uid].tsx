  ...
  return (
    <View style={styles.container}>
      ...
      <View style={[styles.mainContent, isDesktop && styles.desktopContent]}>
        <Text style={styles.errorCode}>IDK</Text>
        <Text style={styles.message}>Aint even started bro ✌️✌️</Text>
        <Text style={styles.subtitle}>
          idk smth abt coordinates? 🫰🫰🫰🫰🫰🫰🫰
        </Text>
        ...
        >
          <Text style={styles.buttonText}>go back ig</Text>
        </Pressable>
      </View>
