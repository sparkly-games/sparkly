  ...
  return (
    <BazingaProvider>
      <Head>
        ...
        <meta property='twitter:image' content={await require('@/assets/images/open_graph_share_preview.png')} />
        ...
        <meta property="og:image" content={await require('@/assets/images/open_graph_share_preview.png')} />
